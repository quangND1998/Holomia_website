  ...
  <div>
          ...
          >
            ...
            <ul class="list-language flex mx-4">
              <li class="menu__item to-left menu-language">
                <a href="/language/en" class="menu__link menu_news"
                  ><img
                    src="images/uk.png"
                    class="img-fluid logo_language w-6 h-6 mx-2"
                    alt=""
                  />
                </a>
              </li>
              <li class="menu__item to-left menu-language">
                <a href="/language/vn" class="menu__link menu_news"
                  ><img
                    src="images/vn.png"
                    class="img-fluid logo_language w-6 h-6 mx-2"
                    alt=""
          ...
          >
            <div class="logo-menu-pc">
              <a href="/index"
                ><img
                  src="images/logo.png"
                  class="logo-holo logo-pc img-fluid w-[240px] xs:w-[120px]"
                  alt=""
              /></a>
            </div>
            <nav
              class="bg-white border-gray-200 flex content-center text-center"
            >
              <div
                ...
                >
                  ...
                  >
                    ...
                    <li>
                      <a
                        href="#"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white"
                        >{{ __("News") }}</a
                      >
                    </li>
                    <li>
              ...
              <form class="max-w-md mx-auto">
                <div class="relative flex">
                  ...
                  <input
                    ...
                    placeholder="Tra cứu thông tin khóa học"
                    required
                  />
                  <button
                    type="submit"
    ...
    <div class="content w-full mx-auto">
      <div class="content1 relative">
        ...
        <div class="absolute top-[10%]">
          <div class="content lg:ml-[15%] lg:w-[70%] md:ml-[10%] md:w-[80%] flex">
            <div class="w-1/2 lg:mr-20 md:mr-2">
              ...
              <p>
                Bạn sẵn sàng chinh phục Tiếng Anh cùng Cambridge IEC chưa? Bạn
                sẵn sàng chinh phục Tiếng Anh cùng Cambridge IEC chưa? Hãy bắt
                đầu con đường dẫn đến thành công ngay hôm nay bằng cách đăng ký
                lớp học phù hợp với mình nào!
              </p>

              <div class="flex mt-10">
                <button
                  type="submit"
                  class="text-white end-2.5 bottom-2.5 bg-[#0F197A] font-medium rounded-lg text-sm px-8 py-3"
                >
                  {{ __("dangkytuvan") }}
                  <i
                    class="uil uil-arrow-right text-white mx-2 text-[14px]"
                  ></i>
                </button>
                <button
                  type="submit"
              ...
              <div class="icon mt-20 flex">
                <div class="flex mx-3">
                  <img
                    ...
                    alt=""
                  />
                  <p class="mx-2 text-center content-center">
                    {{ __("tutingiaotiep") }}
                  </p>
                </div>
                <div class="flex mx-3">
            ...
            <div class="w-1/2 relative">
              ...
              >
                ...
                />
                <div class="mx-4">
                  <p class="text-[#101828] text-[24px] font-semibold">
                    {{ __("camket") }}
                  </p>
        ...
        <div
          class="absolute bottom-[-80px] w-[90%] mx-[5%] bg-white rounded-[20px] flex drop-shadow-md"
        >
      ...
      <div class="containt2">
        <div class="w-[90%] mt-[200px] mb-[60px] mx-auto flex">
          <div class="w-1/2 mx-10">
            <img class="w-full rounded-[10px]" src="images/1.jpg" alt="" />
          </div>
          <div class="w-1/2">
            <p class="text-[#0F197A] uppercase font-semibold text-[18px]">
              Về chúng tôi
            </p>
            <p class="content">
              CAMBRIDGE IEC ENGLISH CENTRE Thành lập từ năm 2009, Trung tâm đào
              tạo Tiếng Anh các cấp độ Mầm non - Tiểu học - Trung học - IELTS.
              Cambridge IEC tự hào khi là đối tác chính thức của IDP và Hội Đồng
              Anh từ 2010. Trong những năm qua, Cambridge IEC đã trở thành địa
              chỉ đáng tin cậy giúp các bạn đăng ký thi IELTS trên toàn quốc,
              đặc biệt là khu vực Hà Nội.
            </p>
            <button
            ...
            >
              {{ __("more") }}
              <i
                class="uil uil-arrow-right text-[#AD0101] mx-2 text-[14px]"
              ></i>
            </button>
              ...
              <div class="w-1/2 mt-10">
                <div class="flex items-center my-2">
                  <img
                    ...
                    alt=""
                  />
                  <p class="mx-2 font-semibold text-[24px]">
                    {{ __("tamnhin") }}
                  </p>
                </div>
                <p class="text-[#667085] text-[16px]">
      ...
      <div class="containt3 mx-auto my-[120px] bg-[#FDF7F7]">
        <div class="justify-center mx-auto text-center my-6">
          <p class="uppercase text-[#0F197A] text-[18px] font-semibold">
            {{ __("reason") }}
          </p>
          <p class="uppercase text-[#101828] text-[40px] my-3 font-semibold">
            HỌC VIÊN CHỌN CAMBRIDGE IEC
          </p>
        </div>
        <div class="w-[90%] mx-auto">
          <vue-glide :perView="3" class="relative">
              ...
              <div class="border rounded-[10px]">
                ...
                <div class="m-4">
                  <div class="my-2">
                    ...
                    <p class="text-[#101828] text-[24px]">
                      Khóa học A2 nâng cao
                    </p>
                    <p class="text-[#667085] text-[16px]">
                      Tham gia khóa học tiếng anh A2 nâng cao của Cambridge IEC,
                      học viên sẽ được...
                    </p>
                  </div>
                  <a class="text-[#0F62FE] mt-10" href=""
                    >Tìm hiểu thêm
                    <i
                      class="uil uil-arrow-right text-[#0F62FE] mx-2 text-[14px]"
                    ></i>
                  </a>
                </div>
              </div>
            ...
            <template slot="control">
              <button
                class="absolute top-[50%] ml-[-30px] w-[60px] h-[60px] bg-[#FFFFFF] bg-opacity-50 rounded-full"
                data-glide-dir="<"
              >
                <img class="w-[52px] ml-5" src="/images/right.png" alt="" />
              </button>
              <button
                class="absolute top-[50%] right-0 mr-[-30px] w-[60px] h-[60px] bg-[#FFFFFF] bg-opacity-50 rounded-full"
                data-glide-dir=">"
              >
                <img class="w-[52px] mr-5" src="/images/left.png" alt="" />
              </button>
            </template>
          </vue-glide>
        </div>
        ...
        <button
          class="text-white flex justify-center items-center mx-auto end-2.5 my-10 bottom-2.5 bg-[#AD0101] font-medium rounded-lg text-sm w-[240px] py-[16px] px-[28px]"
        >
          {{ __("kiemtratrinhdo") }}
        </button>
      </div>
      <div class="containt4 w-[90%] mx-auto my-[120px]">
        <div class="justify-center mx-auto text-center my-6">
          <p class="uppercase text-[#0F197A] text-[18px] font-semibold">
            {{ __("khampha") }}
          </p>
          ...
          <p class="text-[#667085] text-[16px]">
            Các khoá học thực chiến, lộ trình bài bản cung cấp kiến thức và kỹ
            năng đáp ứng nhu cầu của thị trường
          </p>
        </div>

        <vue-glide :perView="4" class="relative">
          <vue-glide-slide v-for="i in 10" :key="i">
            <div class="border rounded-[10px]">
              <img
                class="w-full rounded-t-[10px]"

            ...
            >
              ...
              <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div class="col-span-3 sm:col-span-2">
                  ...
                  >
                        <option value="header" >Have header</option>
                        <option value="not_header" >Not header</option>
                  </select>
                </div>
...
export default {
  ...
  methods: {
    ...
    update() {
      this.form.post(this.route("project.update", this.form.id), {
        preserveState: true,
        onError: (errors) => {
          if (Object.keys(errors).length > 0) {
            this.showModal = true;

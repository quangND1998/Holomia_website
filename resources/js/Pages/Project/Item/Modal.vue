            ...
            >
              ...
              >
                <h3
                  ...
                  v-if="editMode == false"
                >{{ __('create') }} Project</h3>
                <h3 class="text-3xl font-semibold" v-else>{{ __('update') }} Project</h3>
                <button
              ...
              <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div>
                  ...
                  <div
                    :class="errors.thumb ? 'border-red-500' :'' "
...
export default {
  ...
  methods: {
    ...
    save() {
      this.form.post(this.route("item.store", this.project.id), {
        preserveState: true,
    ...
    update() {
      this.form.post(this.route("item.update", this.form.id), {
        preserveState: true,
        onError: errors => {
          if (Object.keys(errors).length > 0) {
            this.showModal = true;

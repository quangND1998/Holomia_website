                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-2">
                                ...
                                accept=".jpg, .jpeg, .png"
                                 class=" p-1.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none " id="file_input" type="file">
                            ...
                            <div class="mb-2">
                                ...
                                <select v-model="form.category_holo360_id" id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            >
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="px-6 py-4">
                            <span class="bg-gray-100 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 border border-gray-500">{{ project.category_project.name }}</span>
                        </td>
                        <td class="px-6 py-4">
                            <button @click="edit(project)"
                          
                                class="font-medium text-blue-600 hover:underline mx-1"
                                >Edit</button
                            >

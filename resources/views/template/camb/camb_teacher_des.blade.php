            ...
            <div class=" w-[80%] mx-auto">
                ...
                @foreach ($section->contents as $content)
                    ...
                    <div class="w-full  h-[680px]">
                        <div class="w-1/3 mx-auto rounded-[20px] border border-[#101F73] bg-[#FFFFFF] px-[40px] py-[32px] relative">
                        ...
                        <div class="flex w-full justify-center items-center my-[64px] ">
                            <div class="w-1/2 flex justify-center items-center">
                                @if (count($content->images) > 0)
                                    <img class="h-[600px] absolute  rounded-[20px]" src="{{ $content->images[0]->image }}"
                                        alt="">
                                @endif
                            </div>

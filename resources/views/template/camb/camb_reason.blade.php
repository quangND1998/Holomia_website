    ...
    <div class="py-[30px] lg:py-[80px]">
        <div class="w-full h-[350px]">
            ...
            <div class="slider_reason w-[80%] mx-auto">
                ...
                <div class="border border-[#00A95A] transition ease-in-out  rounded-[10px] mx-2   duration-300 py-6">
        ...
        <div class="w-full flex justify-center items-center mt-[130px] lg:mt-[100px]">

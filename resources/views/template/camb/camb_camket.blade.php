            ...
            <div class="w-[90%] lg:w-[80%] mx-auto">
                <div class="lg:flex w-full justify-center items-center my-[20px] lg:my-[64px] ">
                    <div class="w-full lg:w-1/2 mr-[20px]">
                        <p class="text-[#016532] uppercase text-[30px] font-semibold w-full text-left my-3">
                            {{ __($section->title) }}</p>
                        ...
                        <a href=""
                                class="text-white  my-[20px] lg:my-[100px] w-[260px] flex justify-center items-center end-2.5 bottom-2.5 bg-[#016532] font-medium rounded-lg text-sm px-8 py-4 ">{{
                                                __('khamphakhoahoc') }}

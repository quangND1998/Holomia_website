<div id="content"  class="">
    <div class="py-[80px]">
        <div class="w-full ">
            <div class="w-[90%] lg:w-[80%] mx-auto flex flex-wrap justify-center mb-[40px]">
                <p class="text-[#101828] uppercase text-[30px] font-semibold w-full text-center my-3 mx-3">{{ __($section->title) }}</p>
            ...
            <div class="slider_introduce w-[100%] mx-auto">
                ...
                <div class="transition ease-in-out  hover:-translate-y-1 hover:scale-110  duration-300 h-[400px] mx-2">
                    ...
                    <img loading="lazy" class="h-[400px] w-[600px] object-cover" src="{{$content->images[0]->image}}" alt="">
                    @endif
                </div>
                @endforeach
            </div>

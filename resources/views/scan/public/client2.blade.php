...
<head>
    ...
    <meta property="og:image" content="https://my.matterport.com/api/v1/player/models/@yield('model-code-head')/thumb" />
...
<body>
    ...
    {{-- <script>
        ...
        chatbox.setAttribute("page_id", "101428939206323");
    ...
    <header class="header">
        ...
        {{-- <div class="icon_menu_function">
            <ul class="list_function">
                <ul class="icon_function_sub">
                    <li class="item_function" id="btn-share">
                        <i class="fa fa-share-alt"></i>
                    </li>
                    <li class="item_function" id="icon_mute">
                        <i class="fa-solid fa-volume-high"></i>
                    </li>
                    <li class="item_function" id="icon_unmute">
                        <i class="fa-solid fa-volume-xmark"></i>
                    </li>
                    <li class="item_function" onclick="showHideTakePicture()">
                        <i class="fa-solid fa-camera"></i>

                    </li>
                    <ul class="show_action_camera">
                        <li onclick="take2d(4096,3072)">4:3 @ 4096x3072</li>
                        <li onclick="take2d(3840,2160)">16:9 @ 3840x2160</li>
                        <li onclick="takeImage360()">Pano @ 4096 x 2048</li>
                    </ul>
                </ul>
                <li class="item_function" id="menu_function">
        ...
        <main>
            <section class="content">
                <iframe src="https://my.matterport.com/show/?m=@yield('model-code-body')&play=1&qs=1" frameborder="0"
        ...
        <script>
            ...
            //                 console.log('Mattertag updated in place in the collection', index, item,
            //                 collection);
            //             }
            //         });
            //     } catch (e) {
            ...
            //                 var d = new Date();
            //                 var id = d.getTime();
            //                 console.log('mpSdk.Camera.takeScreenShot( {width: ' + width + ', height: ' + propHeight +
            //                     '},{mattertags: false, sweeps: true})', '<img id="i' + id + '" />');
            ...
            //             })
            //             .catch(function(error) {
            //                 console.log('mpSdk.Camera.takeScreenShot( {width: 640, height: ' + propHeight +
            //                     '},{mattertags: false, sweeps: true})', 'Error: ' + error);
            ...
            //                 var id = d.getTime();
            //                 console.log(
            //                     'mpSdk.Renderer.takeEquirectangular( {width: 4096, height: 2048},{mattertags: false, sweeps: true})',
            //                     '<img id="i' + id + '" />');
            //                 console.log(screenShotUrl);
            //                 var image_decode = convertBase64toImage(screenShotUrl);
            //             })
